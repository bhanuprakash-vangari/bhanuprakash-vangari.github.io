...
`,$v=()=>{const{themeMode:n,toggleTheme:i}=dv();return p.jsx(rh,{onClick:i,"aria-label":`Switch to ${n==="light"?"dark":"light"} theme`,title:`Switch to ${n==="light"?"dark":"light"} theme`,children:p.jsx(Sv,{children:n==="light"?p.jsx(kv,{}):p.jsx(wv,{})})})},Cv=_.nav`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Lv=({navItems:n,brandText:i,brandHref:a="#"})=>{const[u,c]=P.useState(!1),[d,h]=P.useState(!1);P.useEffect(()=>{const y=()=>{const k=window.scrollY>150;h(k)};return window.addEventListener("scroll",y),()=>window.removeEventListener("scroll",y)},[]);const v=()=>{c(!1)},m=()=>{c(!u)};return p.jsx(Cv,{$isScrolled:d,children:p.jsxs(Ev,{children:[p.jsxs(jv,{href:a,children:[p.jsx("span",{children:"V"}),i]}),p.jsx(Pv,{onClick:m,"aria-label":"Toggle navigation",children:p.jsx(Tv,{})}),p.jsx(Rv,{$isOpen:u,children:p.jsx(_v,{children:n.map(y=>p.jsx(zv,{children:p.jsx(Iv,{href:y.href,onClick:v,children:p.jsx("span",{children:y.label})})},y.id))})})]})})},Nv=_.div`
  width: 100%;
  margin: 0 auto;
  padding: 0 ${({theme:n})=>n.spacing[4]};
...
`,Ir=({children:n,fluid:i=!1,className:a})=>p.jsx(Nv,{$fluid:i,className:a,children:n}),bv=({texts:n,typeSpeed:i=100,deleteSpeed:a=50,pauseDuration:u=1e3})=>{const[c,d]=P.useState(""),[h,v]=P.useState(0),[m,y]=P.useState(!1),k=P.useRef(null);return P.useEffect(()=>{if(n.length===0)return;const j=()=>{const T=n[h];d(m?T.substring(0,c.length-1):T.substring(0,c.length+1));let z=m?a:i;!m&&c===T?(z=u,y(!0)):m&&c===""&&(y(!1),v(A=>(A+1)%n.length),z=i),k.current=setTimeout(j,z)};return k.current=setTimeout(j,i),()=>{k.current&&clearTimeout(k.current)}},[c,h,m,n,i,a,u]),{currentText:c,isDeleting:m}},Dv=Io`
  0%, 50% {
    opacity: 1;
  }
  51%, 100% {
...
`,r1=()=>{const n=()=>{const i=document.getElementById("about-section");i&&i.scrollIntoView({behavior:"smooth"})};return p.jsxs(Gv,{id:"home-section",children:[p.jsx(Kv,{}),p.jsx(Ir,{children:p.jsx(Xv,{children:p.jsxs(Jv,{children:[p.jsx(qv,{children:"Hey! I am"}),p.jsx(Zv,{children:"Vangari Bhanu Prakash"}),p.jsxs(e1,{children:["I'm a"," ",p.jsx(Mv,{texts:Yv,typeSpeed:100,deleteSpeed:50,pauseDuration:2e3})]})]})})}),p.jsx(t1,{onClick:n,"aria-label":"Scroll down",children:p.jsx(n1,{children:p.jsx(xv,{})})})]})},o1={white:be`
...
`,V1=()=>{const[n,i]=P.useState("education"),a=u=>{i(u)};return p.jsx(Lo,{id:"resume-section",children:p.jsx(Ir,{children:p.jsxs(O1,{children:[p.jsx(M1,{children:p.jsxs(F1,{children:[p.jsx(Ns,{children:p.jsx(bs,{href:"#education",$isActive:n==="education",onClick:u=>{u.preventDefault(),a("education")},children:"Education"})}),p.jsx(Ns,{children:p.jsx(bs,{href:"#experience",$isActive:n==="experience",onClick:u=>{u.preventDefault(),a("experience")},children:"Experience"})}),p.jsx(Ns,{children:p.jsx(bs,{href:"#skills",$isActive:n==="skills",onClick:u=>{u.preventDefault(),a("skills")},children:"Skills"})})]})}),p.jsxs(U1,{children:[n==="education"&&p.jsxs(Ds,{children:[p.jsx(As,{children:"Education"}),Fv.map(u=>p.jsx(Gd,{children:p.jsxs(Kd,{children:[p.jsx(Xd,{children:u.date}),p.jsx(Jd,{children:u.degree}),p.jsx(qd,{children:u.institution}),p.jsxs(Zd,{children:[p.jsx("strong",{children:"CGPA: "}),u.cgpa]}),p.jsx(ep,{children:u.description})]})},u.id))]}),n==="experience"&&p.jsxs(Ds,{children:[p.jsx(As,{children:"Experience"}),Uv.map(u=>p.jsx(Gd,{children:p.jsxs(Kd,{children:[p.jsx(Xd,{children:u.date}),p.jsx(Jd,{children:u.position}),p.jsx(qd,{children:u.company}),u.awards&&p.jsxs(Zd,{children:[p.jsx("strong",{children:"Awards: "}),u.awards]}),p.jsx(ep,{children:u.description})]})},u.id))]}),n==="skills"&&p.jsxs(Ds,{children:[p.jsx(As,{children:"Skills"}),p.jsx(H1,{children:Wv.map(u=>p.jsx(A1,{skill:u},u.name))}),p.jsx(W1,{children:p.jsx(B1,{children:Hv.map(u=>p.jsx(P1,{value:u.percentage,color:u.color,label:u.name,showPercentage:!0,animated:!0},u.name))})})]})]})]})})})},ih=_.div`
  cursor: pointer;
  transition: transform ${({theme:n})=>n.transitions.base};
  border-radius: ${({theme:n})=>n.borderRadius.lg};
  overflow: hidden;
...
`,rx=()=>p.jsx(Lo,{id:"projects-section",children:p.jsxs(Ir,{fluid:!0,children:[p.jsxs(q1,{children:[p.jsx(Z1,{children:"Projects"}),p.jsx(ex,{children:"My Work"}),p.jsx(tx,{children:'"Risk something or forever sit with your dreams." – Herb Brooks'})]}),p.jsx(nx,{children:Bv.map(n=>p.jsx(J1,{project:n},n.id))})]})}),ox=_.div`
  text-align: center;
  margin-bottom: ${({theme:n})=>n.spacing[12]};
  max-width: 700px;
  margin-left: auto;
