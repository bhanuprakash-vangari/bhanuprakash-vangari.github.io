...
`,bv=({navItems:n,brandText:i,brandHref:a="#"})=>{const[u,c]=P.useState(!1),[d,h]=P.useState(!1);P.useEffect(()=>{const y=()=>{const k=window.scrollY>150;h(k)};return window.addEventListener("scroll",y),()=>window.removeEventListener("scroll",y)},[]);const v=()=>{c(!1)},m=()=>{c(!u)};return p.jsx(Ev,{$isScrolled:d,children:p.jsxs(jv,{children:[p.jsxs(Pv,{href:a,children:[p.jsx("span",{children:"V"}),i]}),p.jsx(Tv,{onClick:m,"aria-label":"Toggle navigation",children:p.jsx(Rv,{})}),p.jsx(_v,{$isOpen:u,children:p.jsx(zv,{children:n.map(y=>p.jsx(Iv,{children:p.jsx(Lv,{href:y.href,onClick:v,children:p.jsx("span",{children:y.label})})},y.id))})})]})})},Nv=_.div`
  width: 100%;
  margin: 0 auto;
  padding: 0 ${({theme:n})=>n.spacing[4]};
...
`,Ir=({children:n,fluid:i=!1,className:a})=>p.jsx(Nv,{$fluid:i,className:a,children:n}),Dv=({texts:n,typeSpeed:i=100,deleteSpeed:a=50,pauseDuration:u=1e3})=>{const[c,d]=P.useState(""),[h,v]=P.useState(0),[m,y]=P.useState(!1),k=P.useRef(null);return P.useEffect(()=>{if(n.length===0)return;const j=()=>{const T=n[h];d(m?T.substring(0,c.length-1):T.substring(0,c.length+1));let z=m?a:i;!m&&c===T?(z=u,y(!0)):m&&c===""&&(y(!1),v(O=>(O+1)%n.length),z=i),k.current=setTimeout(j,z)};return k.current=setTimeout(j,i),()=>{k.current&&clearTimeout(k.current)}},[c,h,m,n,i,a,u]),{currentText:c,isDeleting:m}},Ov=Io`
  0%, 50% {
    opacity: 1;
  }
  51%, 100% {
...
`,o1=()=>{const n=()=>{const i=document.getElementById("about-section");i&&i.scrollIntoView({behavior:"smooth"})};return p.jsxs(Kv,{id:"home-section",children:[p.jsx(Xv,{}),p.jsx(Ir,{children:p.jsx(Jv,{children:p.jsxs(qv,{children:[p.jsx(Zv,{children:"Hey! I am"}),p.jsx(e1,{children:"Vangari Bhanu Prakash"}),p.jsxs(t1,{children:["I'm a"," ",p.jsx(Fv,{texts:Gv,typeSpeed:100,deleteSpeed:50,pauseDuration:2e3})]})]})})}),p.jsx(n1,{onClick:n,"aria-label":"Scroll down",children:p.jsx(r1,{children:p.jsx(xv,{})})})]})},i1={white:Ne`
  ...
  ${({$noPadding:n,theme:i})=>!n&&Ne`
    ...
    `}
`,Lo=P.forwardRef(({children:n,id:i,className:a,noPadding:u=!1,backgroundColor:c="white"},d)=>p.jsx(l1,{ref:d,id:i,className:a,$noPadding:u,$backgroundColor:c,children:n}));Lo.displayName="Section";const a1={primary:Ne`
    background-color: ${({theme:n})=>n.colors.primary};
    color: ${({theme:n})=>n.colors.white};
...
`,A1=({skill:n,size:i=120,strokeWidth:a=8})=>{const u=(i-a)/2,c=u*2*Math.PI,d=c-n.value/100*c;return p.jsx(_1,{children:p.jsxs(z1,{children:[p.jsx(I1,{children:n.name}),p.jsxs(L1,{width:i,height:i,children:[p.jsx(b1,{cx:i/2,cy:i/2,r:u,strokeWidth:a}),p.jsx(N1,{cx:i/2,cy:i/2,r:u,strokeWidth:a,strokeDasharray:c,strokeDashoffset:d,transform:`rotate(-90 ${i/2} ${i/2})`})]}),p.jsx(D1,{children:p.jsxs("div",{className:"percentage",children:[n.value,p.jsx("sup",{children:"%"})]})}),p.jsxs(O1,{children:[p.jsxs(Yd,{children:[p.jsxs("div",{className:"value",children:[n.lastWeek,"%"]}),p.jsx("span",{className:"label",children:"Last week"})]}),p.jsxs(Yd,{children:[p.jsxs("div",{className:"value",children:[n.lastMonth,"%"]}),p.jsx("span",{className:"label",children:"Last month"})]})]})]})})},M1=_.div`
  display: grid;
...
`,Q1=()=>{const[n,i]=P.useState("education"),a=u=>{i(u)};return p.jsx(Lo,{id:"resume-section",children:p.jsx(Ir,{children:p.jsxs(M1,{children:[p.jsx(F1,{children:p.jsxs(U1,{children:[p.jsx(bs,{children:p.jsx(Ns,{href:"#education",$isActive:n==="education",onClick:u=>{u.preventDefault(),a("education")},children:"Education"})}),p.jsx(bs,{children:p.jsx(Ns,{href:"#experience",$isActive:n==="experience",onClick:u=>{u.preventDefault(),a("experience")},children:"Experience"})}),p.jsx(bs,{children:p.jsx(Ns,{href:"#skills",$isActive:n==="skills",onClick:u=>{u.preventDefault(),a("skills")},children:"Skills"})})]})}),p.jsxs(H1,{children:[n==="education"&&p.jsxs(Ds,{children:[p.jsx(Os,{children:"Education"}),Uv.map(u=>p.jsx(Gd,{children:p.jsxs(Kd,{children:[p.jsx(Xd,{children:u.date}),p.jsx(Jd,{children:u.degree}),p.jsx(qd,{children:u.institution}),p.jsxs(Zd,{children:[p.jsx("strong",{children:"CGPA: "}),u.cgpa]}),p.jsx(ep,{children:u.description})]})},u.id))]}),n==="experience"&&p.jsxs(Ds,{children:[p.jsx(Os,{children:"Experience"}),Hv.map(u=>p.jsx(Gd,{children:p.jsxs(Kd,{children:[p.jsx(Xd,{children:u.date}),p.jsx(Jd,{children:u.position}),p.jsx(qd,{children:u.company}),u.awards&&p.jsxs(Zd,{children:[p.jsx("strong",{children:"Awards: "}),u.awards]}),p.jsx(ep,{children:u.description})]})},u.id))]}),n==="skills"&&p.jsxs(Ds,{children:[p.jsx(Os,{children:"Skills"}),p.jsx(W1,{children:Bv.map(u=>p.jsx(A1,{skill:u},u.name))}),p.jsx(B1,{children:p.jsx(V1,{children:Wv.map(u=>p.jsx(T1,{value:u.percentage,color:u.color,label:u.name,showPercentage:!0,animated:!0},u.name))})})]})]})]})})})},ih=_.div`
  cursor: pointer;
  transition: transform ${({theme:n})=>n.transitions.base};
  border-radius: ${({theme:n})=>n.borderRadius.lg};
  overflow: hidden;
...
`,ox=()=>p.jsx(Lo,{id:"projects-section",children:p.jsxs(Ir,{fluid:!0,children:[p.jsxs(Z1,{children:[p.jsx(ex,{children:"Projects"}),p.jsx(tx,{children:"My Work"}),p.jsx(nx,{children:'"Risk something or forever sit with your dreams." – Herb Brooks'})]}),p.jsx(rx,{children:Vv.map(n=>p.jsx(q1,{project:n},n.id))})]})}),ix=_.div`
  text-align: center;
  margin-bottom: ${({theme:n})=>n.spacing[12]};
  max-width: 700px;
  margin-left: auto;
